...
glutResultsControllers.controller("resultsCtrl", [ "$scope", "$routeParams", "factoryTwitterSearch", function(a, b, c) {
    ...
    } ], c.getTweetsBySearchId(b.searchId).then(function(a) {
        console.log("found search and pulled data to the scope level-", a);
    });
} ]);
...
glutSearchControllers.controller("searchCtrl", [ "$scope", "factoryLatLng", "factoryTwitterSearch", function(a, b, c) {
    ...
    a.search.radiusUnit = "Km", a.search.useCurrentLocation = "Use My Location", a.search.usedCurrentLocation = !1, 
