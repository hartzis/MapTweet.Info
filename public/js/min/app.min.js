...
function onGoogleReady() {
    console.log("google maps ready - loading angular glutApp"), angular.bootstrap(document.body, [ "glutApp" ]);
}

var glutApp = angular.module("glutApp", [ "ngResource", "ngRoute", "glutSearchControllers", "glutResultsControllers", "glutLatLngServices", "glutTwitterSearchServices", "glutMapServices", "ui.bootstrap", "ui.map" ]);
...
glutResultsControllers.controller("resultsCtrl", [ "$scope", "$routeParams", "factoryTwitterSearch", "markerFactory", function(a, b, c, d) {
    console.log("loaded resultsCtrl"), a.mapOptions = {
        center: new google.maps.LatLng(20, -30),
        zoom: 2,
        mapTypeId: google.maps.MapTypeId.ROADMAP
    }, a.myMarkers = [], a.searchId = b.searchId, a.results = {}, a.results.tweets = [], 
    a.results.geoTweets = [], a.results.returned = !1, c.getTweetsBySearchId(b.searchId).then(function(b) {
        console.log("setting map to-", a.myMap), d.setMyMap(a.myMap), console.log("map set to-", d.getMyMap()), 
        ...
        a.results.geoTweets = a.results.tweets.filter(function(a) {
            return null != a.geo;
        }), console.log("trying to make markers for-", a.results.geoTweets);
        for (var c = 0; c < a.results.geoTweets.length; c++) {
            console.log("making marker for-", a.results.geoTweets[c]);
        ...
        a.currentMarker = b, a.currentMarkerLat = b.getPosition().lat(), a.currentMarkerLng = b.getPosition().lng(), 
        a.myInfoWindow.open(a.myMap, b);
    }, a.panToOpenInfo = function(b) {
        a.myMap.panTo(b.getPosition()), a.currentMarker = b, a.currentMarkerLat = b.getPosition().lat(), 
        a.currentMarkerLng = b.getPosition().lng(), a.myInfoWindow.open(a.myMap, b);
    };
} ]);
...
glutSearchControllers.controller("searchCtrl", [ "$scope", "factoryLatLng", "factoryTwitterSearch", function(a, b, c) {
    ...
    a.search.radius = "10", a.search.radiusUnit = "Km", a.search.useCurrentLocation = "Use My Current Location", 
