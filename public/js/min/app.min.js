...
glutResultsControllers.controller("resultsCtrl", [ "$scope", "$routeParams", "factoryTwitterSearch", "markerFactory", function(a, b, c, d) {
    ...
    a.results = {}, a.results.tweets = [], a.results.geoTweets = [], a.results.returned = !1, 
    c.getTweetsBySearchId(b.searchId).then(function(b) {
        d.setMyMap(a.myMap), a.results.tweets = b.statuses, a.results.geoTweets = a.results.tweets.filter(function(a) {
            return null != a.geo;
        });
        ...
        }), a.myMap.setCenter(b.getCenter()), a.myMap.fitBounds(b), a.myMap.getZoom() >= 18 && a.myMap.setZoom(17);
...
glutSearchControllers.controller("searchCtrl", [ "$scope", "factoryLatLng", "factoryTwitterSearch", function(a, b, c) {
    ...
    a.search.retrievingCurrentLoc = !1, a.changeRadiusUnit = function(b) {
        ...
        b.getCurrentLocation(function(b) {
            ...
            a.search.longitude = b.longitude, a.search.usedCurrentLocation = !0, a.search.retrievingCurrentLoc = !1, 
            a.search.useCurrentLocation = "Use My Current Location", a.$apply());
        });
