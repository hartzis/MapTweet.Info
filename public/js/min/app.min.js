...
!function() {
    var a = angular.module("mapTweetInfoApp", [ "ngResource", "ngRoute", "searchControllers", "resultsControllers", "historyControllers", "latLngServices", "twitterSearchServices", "mapServices", "historyServices", "ngEnterDirectives", "ui.bootstrap", "ui.map" ]);
    ...
    var a = angular.module("historyControllers", []);
    a.controller("historyCtrl", [ "$scope", "$modal", "historyFactory", function(a, b, c) {
    ...
    } ]), a.controller("confirmRemoveCtrl", [ "$scope", "$modalInstance", function(a, b) {
    ...
    var a = angular.module("resultsControllers", [ "ngSanitize" ]);
    a.controller("resultsCtrl", [ "$scope", "$routeParams", "factoryTwitterSearch", "markerFactory", function(a, b, c, d) {
        a.mapOptions = {
    ...
    a.controller("searchCtrl", [ "$scope", "$location", "factoryLatLng", "factoryTwitterSearch", function(a, b, c, d) {
        ...
        a.gotLatLng = !1;
        for (var e in b.search()) b.search().hasOwnProperty(e) && (a.search[e] = "radius" === e ? parseInt(b.search()[e]) : b.search()[e]);
    ...
    var a = angular.module("ngEnterDirectives", []);
    ...
    var a = angular.module("tweetDirectives", []);
    a.directive("tweetPanel", [ function() {
        return {
            restrict: "E",
    ...
    var a = angular.module("historyServices", []);
    a.factory("historyFactory", [ "$http", "$location", function(a, b) {
        return {
            removeAll: function() {
    ...
    var a = angular.module("latLngServices", []);
    a.factory("factoryLatLng", [ "$http", function(a) {
        return {
    ...
    var a = angular.module("mapServices", []);
    a.factory("markerFactory", [ function() {
        var a = null;
        return {
            setMyMap: function(b) {
                a = b;
    ...
    var a = angular.module("twitterSearchServices", []);
    a.factory("factoryTwitterSearch", [ "$http", "$location", function(a, b) {
        return {
