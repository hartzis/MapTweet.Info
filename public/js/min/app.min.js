...
historyControllers.controller("historyCtrl", [ "$scope", "historyFactory", function(a, b) {
    a.user = {}, b.retrieveSearchHistory().then(function(b) {
        ...
        b.copyToSearch(a);
    }, a.removeSearch = function(c) {
        b.removeSearch(c._id).then(function(b) {
            "removed" === b && a.user.geo_searches.splice(a.user.geo_searches.indexOf(c), 1);
        });
    };
} ]);
...
resultsControllers.controller("resultsCtrl", [ "$scope", "$routeParams", "factoryTwitterSearch", "markerFactory", function(a, b, c, d) {
    ...
    a.results.returned = !1, c.getTweetsBySearchId(b.searchId).then(function(b) {
        a.search = b.search, d.setMyMap(a.myMap), a.results.tweets = b.statuses, angular.forEach(a.results.tweets, function(a) {
        ...
        console.log("copying this tweet over-", b), a.currentMarkerInfo.user = b.user, a.currentMarkerInfo.created_at = b.created_at, 
